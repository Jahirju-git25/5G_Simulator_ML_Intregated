...
Simplified version without Dual Connectivity
"""
import math
from .mobility_new import MobilityModel
...
class UE:
    ...
    def to_dict(self):
        d = {
            ...
            'serving':          self.serving_gnb_id,  # Alias for ML client compatibility
            'target_gnb':       self.ttt_target if self.ttt_target else None,  # Current HO target
            'rsrp':             self.rsrp,
            'rsrq':             self.rsrq,
            'sinr':             self.sinr,
